...
What sets my work apart is the range — I've shipped code across embedded systems, backend, web, and mobile, on two production systems at once. If you want to talk about robotics, ML, or building things that run on real hardware, reach out.
